...
Write the full output to `BOLIGA-MARKET-REPORT.md` using the template at `templates/boliga-report.md`. Fill in all placeholder values with data from the analysis phases above.
